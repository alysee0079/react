...
function processUpdateQueue(workInProgress, props, instance, renderLanes) {
  ...
  if (pendingQueue !== null) {
    ...
    // 需要将新产生的 firstPendingUpdate 赋值为 firstBaseUpdate, lastPendingUpdate 赋值为 为 lastBaseUpdate, 组成 update 队列
    // 2.如果 lastBaseUpdate 存在, 则证明上次有遗留的 update, 需要将新产生的 firstPendingUpdate 放到 lastBaseUpdate 的后面,
    if (lastBaseUpdate === null) {
...
function ChildReconciler(shouldTrackSideEffects) {
  ...
  function placeChild(newFiber, lastPlacedIndex, newIndex) {
    ...
    if (current !== null) {
      ...
      // current 不存在, 说明是新增的节点,  lastPlacedIndex 不变
      newFiber.flags = Placement;
      return lastPlacedIndex;
    }
  }
  ...
  function reconcileChildrenArray(returnFiber, currentFirstChild, newChildren, lanes) {
    ...
    var previousNewFiber = null; // 新节点中上次对比过的节点
    var oldFiber = currentFirstChild; // 正在对比的 oldFiber
    var lastPlacedIndex = 0; // 上一次匹配到的可复用节点对应的 index
    var newIdx = 0; // 新节点中对比到了的位置
    var nextOldFiber = null; // 下一个要对比的 oldFiber
    ...
    for (; oldFiber !== null && newIdx < newChildren.length; newIdx++) {
      ...
      if (newFiber === null) {
        ...
        // newFiber 为 null, 可以认为 key 不等, 跳出本次循环
        break;
      }
    ...
    // 如果 oldFiber 序列被遍历完, 那么 newChildren 序列中剩余节点都视为新增(打上Placement标记)
    if (oldFiber === null) {
...
function createWorkInProgress(current, pendingProps) {
  ...
  // 初始化时: current = rootFiber, rootFiber.alternate = null
  if (workInProgress === null) {
